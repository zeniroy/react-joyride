...
function (_React$Component) {
  ...
  function JoyrideOverlay(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "spotlight", React__default.createRef());
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "fixTop", function () {
      ...
      _this.spotlight.current.css.style.top = "".concat(offset.top, "px");
    });
